...
<body>
        ...
        <div class="content d-flex justify-content-center align-items-center flex-column">
            ...
            <div class="main-view d-flex flex-column justify-content-center align-items-center shadow-sm"
                ...
                <h1 class="text-light">
                    ...
                    <span class="text-primary" style="text-shadow: 0 0 2px #fefefeff">
                        Diary Of Learning
                    </span>
                </h1>

                <p class="text-light text-start w-75 fs-5 text-sm-center">
                    Tingkatkan kemampuanmu setiap hari dengan catatan belajar, progress harian,
                    dan materi yang kamu pelajari. Pantau perkembanganmu dan jadikan belajar sebagai
                    kebiasaan terbaikmu.
                </p>
            </div>
    ...
    <script>
        ...
        new Chart(document.getElementById("grafik"), config);
    </script>
